...
const char* mqtt_server = "connect.nustem.uk";
...
void setup() {
    ...
    servoPosition[0][2] = 0.0; // Servo1 state B
    servoPosition[1][1] = 180.0; // Servo2 state A
...
void loop() {
    ...
    if (time_current < time_end) {
        ...
        // a counting function to test whether the transition time is getting updated
